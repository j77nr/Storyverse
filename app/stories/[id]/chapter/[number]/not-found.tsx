      ...
      <div className="text-center">
        <div className="mb-6 flex justify-center">
          <div className="rounded-full bg-foreground/10 p-6">
            <FileQuestion className="h-16 w-16 text-foreground/60" />
          </div>
        </div>
        <h1 className="mb-4 text-4xl font-bold">Chapitre non trouvé</h1>
        <p className="mb-8 text-lg text-foreground/70">
          Désolé, ce chapitre n'existe pas ou n'est pas encore disponible.
        </p>
