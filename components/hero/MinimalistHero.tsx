...
export const MinimalistHero = ({
  ...
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center px-8 md:grid-cols-3 md:px-12">
        {/* Left Text Content */}
        <motion.div
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
            ...
            <motion.img
                src={imageSrc}
                alt={imageAlt}
                className="relative z-10 h-auto w-72 object-cover md:w-80 scale-125 lg:w-96"
      ...
      {/* Footer Elements */}
      <footer className="z-30 flex w-full max-w-7xl items-center justify-between px-8 pb-8 md:px-12 md:pb-12">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
